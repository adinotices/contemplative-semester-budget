  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-wrap items-end gap-3">
      <div>
        ...
        <input name="name" required className="rounded-lg border border-neutral-300 px-2 py-1.5 text-sm" />
      </div>
      <div>
        <label className="mb-1 block text-xs font-medium text-neutral-600">Type</label>
        <select name="type" className="rounded-lg border border-neutral-300 px-2 py-1.5 text-sm">
          <option value="expense">Expense</option>
          <option value="income">Income</option>
        </select>
      </div>
      <div>
        <label className="mb-1 block text-xs font-medium text-neutral-600">Budget target</label>
        <input
          name="budget_target"
          type="number"
          step="0.01"
