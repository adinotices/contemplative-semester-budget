            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                {budgetVsActual.map((row) => (
                  <tr key={`${row.category}-${row.type}`} className="border-b border-neutral-100">
                    <td className="py-2">{row.category}</td>
                    <td className="py-2 capitalize text-neutral-500">{row.type}</td>
        ...
        <section className="rounded-xl border border-neutral-200 bg-white p-5">
          ...
          {breakdown.length === 0 ? (
            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                {breakdown.map((row) => (
                  <tr key={`${row.category}-${row.direction}`} className="border-b border-neutral-100">
                    <td className="py-2">{row.category}</td>
                    <td className="py-2 capitalize text-neutral-500">{row.direction}</td>
